...
class MaterialTheme {
  ...
  static MaterialScheme lightMediumContrastScheme() {
    return const MaterialScheme(
      ...
      surfaceTint: Color(0xff006a68),
      onPrimary: Color(0xffffffff),
      primaryContainer: Color(0xff24817f),
  ...
  static MaterialScheme darkHighContrastScheme() {
    return const MaterialScheme(
      ...
      primaryContainer: Color(0xff84d9d6),
      onPrimaryContainer: Color(0xff000000),
      ...
      tertiaryContainer: Color(0xffb6ccec),
      onTertiaryContainer: Color(0xff000000),
      ...
      primaryFixed: Color(0xffa1f6f3),
      onPrimaryFixed: Color(0xff000000),
      primaryFixedDim: Color(0xff84d9d6),
      ...
      tertiaryFixedDim: Color(0xffb6ccec),
